const CSAT11Desktop = () => {
  return (
    <div className="relative rounded-3xl bg-surfaces-primary-surface shadow-[20px_20px_80px_rgba(0,_0,_0,_0.14)] w-full h-[1024px] overflow-hidden text-left text-base text-mediumslateblue font-body-l-semibold">
      <div className="absolute h-full w-full top-[0px] right-[0px] bottom-[0px] left-[0px] rounded-3xl overflow-hidden mix-blend-normal">
        <img
          className="absolute top-[264px] left-[596px] w-[248px] h-[248px] overflow-hidden"
          alt=""
          src="/httpslottiefilescom73234robotassistantonlinemanager.svg"
        />
        <div className="absolute top-[648px] left-[calc(50%_-_143px)] rounded-3xs box-border w-[286px] h-14 flex flex-row py-2 px-6 items-center justify-center gap-[12px] border-[2px] border-solid border-mediumslateblue">
          <img
      ...
      <b className="absolute top-[556px] left-[calc(50%_-_489px)] text-29xl leading-[44px] flex text-neutrals-grey-10 text-center items-center justify-center w-[979px]">
